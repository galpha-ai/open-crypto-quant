...
use crate::parser::ray_ammv4::state::{AmmParams, Fees, LastOrderDistance, SimulateParams};
...
pub fn swap_base_in(
    ...
    eprintln!("   >>>   spl_token={:?}", accounts[0]);
    eprintln!("   >>>   amm_pool={:?}", accounts[1]);
    eprintln!("   >>>   amm_authority={:?}", accounts[2]);
    eprintln!("   >>>   amm_open_orders={:?}", accounts[3]);
    eprintln!("   >>>   amm_target_orders={:?}", accounts[4]);
    eprintln!("   >>>   amm_coin_vault={:?}", accounts[5]);
    eprintln!("   >>>   amm_pc_vault={:?}", accounts[6]);
    eprintln!("   >>>   market_program={:?}", accounts[7]);
    eprintln!("   >>>   market={:?}", accounts[8]);
    eprintln!("   >>>   market_bids={:?}", accounts[9]);
    eprintln!("   >>>   market_asks={:?}", accounts[0xA]);
    eprintln!("   >>>   market_event_queue={:?}", accounts[0xB]);
    eprintln!("   >>>   market_coin_vault={:?}", accounts[0xC]);
    eprintln!("   >>>   market_pc_vault={:?}", accounts[0xD]);
    eprintln!("   >>>   market_vault_signer={:?}", accounts[0xE]);
    eprintln!("   >>>   user_token_source={:?}", accounts[0xF]);
    eprintln!("   >>>   user_token_destination={:?}", accounts[0x10]);
    eprintln!("   >>>   user_source_owner={:?}", accounts[0x11]);
...
pub fn swap_base_out(
    ...
    let accounts = vec![
        ...
        AccountMeta::new(*amm_open_orders, false),
        AccountMeta::new(*amm_target, false),
        AccountMeta::new(*amm_coin_vault, false), // pool coin token acct
        AccountMeta::new(*amm_pc_vault, false),   // pool pc token acct
        // market
        AccountMeta::new_readonly(*market_program, false),
        AccountMeta::new(*market, false),             // serum mkt
        AccountMeta::new(*market_bids, false),        // serum bids
        AccountMeta::new(*market_asks, false),        // serum asks
        AccountMeta::new(*market_event_queue, false), // serum event queue
        AccountMeta::new(*market_coin_vault, false),  // serum coin-v acct
        AccountMeta::new(*market_pc_vault, false),    // serum pc-v acct
        AccountMeta::new_readonly(*market_vault_signer, false),
        // user
        AccountMeta::new(*user_token_source, false),
        AccountMeta::new(*user_token_destination, false),
