...
//    additional_signers: Option<&'a [&Pubkey]>,
//    //#[cfg(feature = "versioned-tx")]
//    address_lookup_table_accounts: Option<&[AddressLookupTableAccount]>,
//) -> Result<impl SerializableTransaction + use<'a>, error::ClientError> {
