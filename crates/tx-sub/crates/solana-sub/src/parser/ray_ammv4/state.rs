...
use crate::parser::ray_ammv4::{error::AmmError, math::Calculator};
...
mod test {
    ...
    //         owner[0..8].copy_from_slice(&0x123456789abcedf0u64.to_le_bytes());
    //         owner[8..16].copy_from_slice(&0x123456789abced0fu64.to_le_bytes());
    //         owner[16..24].copy_from_slice(&0x123456789abce0dfu64.to_le_bytes());
    //         owner[24..32].copy_from_slice(&0x123456789abc0edfu64.to_le_bytes());
    //         owner
    //     };
