...
/// Create an optimized HTTP client with proxy support
/// proxy_url format: "http://user:pass@host:port"
pub fn create_optimized_client_with_proxy(proxy_url: &str) -> Result<Client, reqwest::Error> {
    ...
    ClientBuilder::new()
        ...
        .gzip(true)
        .user_agent("polyfill-rs/0.1.1 (proxy-trading)")
        .build()
}
